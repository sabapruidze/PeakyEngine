...
export const ACTION_DESCRIPTIONS: Record<StateActionKind, string> = {
  ...
  PlayPlacementAnim: "Start (or resume) the animation on every Sprite Object placement of the chosen sprite.",
  ...
  CreateSpriteObject: "Spawn a new Sprite Object placement at runtime using the chosen sprite asset. Lighter than CreateObject (no BP, no behaviors).",
...
export const ACTION_DEFAULTS: Record<StateActionKind, Record<string, unknown>> = {
  ...
  HitStop: { durationMs: 80, delayMs: 50, scale: 0, affectPhysics: true, affectParticles: true },
  ...
  PlayPlacementAnim: { spriteId: "", animation: "", loop: true, startFrame: 0 },
  StopPlacementAnim: { spriteId: "" },
  SetPlacementPos: { spriteId: "", x: 0, y: 0 },
  CreateSpriteObject: { spriteId: "", x: 0, y: 0 },
